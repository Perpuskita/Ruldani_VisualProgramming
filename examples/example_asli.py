...
class visual_programming(tk.Tk):
    ...
    def ribbon_widget(self, menubar: ctk.CTkFrame):
        btn_home = ctk.CTkButton(menubar, width=50, height=10, text="save", fg_color=BACKGROUND_COLOR, hover_color=ORANGE_PALLETE)
        btn_home.grid(row=0, column=1, padx=(10, 2), sticky="w")

        btn_home = ctk.CTkButton(menubar, width=50, height=10, text="load", fg_color=BACKGROUND_COLOR, hover_color=ORANGE_PALLETE)
        btn_home.grid(row=0, column=2, padx=2, sticky="w")

        btn_home = ctk.CTkButton(menubar, width=50, height=10, text="tools", fg_color=BACKGROUND_COLOR, hover_color=ORANGE_PALLETE)
        btn_home.grid(row=0, column=3, padx=2, sticky="w")

        btn_home = ctk.CTkButton(menubar, width=50, height=10, text="help", fg_color=BACKGROUND_COLOR, hover_color=ORANGE_PALLETE)
    ...
    def setting_sidebar_widget(self, master: ctk.CTkFrame):
        ...
        setting = atomic.button_with_image(master=master, size=[15, 15], icon_name= "cpm2.png",fg_color= BACKGROUND_COLOR, hover_color=ORANGE_PALLETE)
        setting.grid(row=1, column=0, pady= 5, padx=(5, 5), sticky="n")

        setting = atomic.button_with_image(master=master, size=[15, 15], icon_name= "cpm3.png",fg_color= BACKGROUND_COLOR, hover_color=ORANGE_PALLETE)
    ...
    def setting_widget(self, workspace: ctk.CTkFrame) -> ctk.CTkFrame:
        ...
        setting.grid_columnconfigure(2, weight=1)
        return setting
